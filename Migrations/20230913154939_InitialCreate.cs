    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "davidmcdavid@davidmcdavid.com", "David", "McDavid" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 3, "https://www.reddit.com/media?url=https%3A%2F%2Fi.redd.it%2Fvl0elvghb1j31.jpg", "Bucklesby" },
                    { 3, 2, "https://www.reddit.com/media?url=https%3A%2F%2Fi.redd.it%2F64rtmh28xx261.jpg", "Trolls" },
                    { 4, 2, "https://www.reddit.com/media?url=https%3A%2F%2Fi.redd.it%2Ftlgt4sxf2b051.png", "Parking Lot" },
                    { 5, 4, "https://i.redd.it/ucc6k6ou95y41.jpg", "Tropical Paradise" },
                    { 6, 3, "https://i.redd.it/02ty6pivu8q31.jpg", "Primitive Indeed" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 4, new DateTime(2023, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
